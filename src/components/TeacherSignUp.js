...
const TeacherSignUp = ({ setIsTeacherSignUp, handleInputChange, formData = {}, errors = {} }) => {
  ...
  return (
    <div className="signup-page card mx-auto my-5" style={{ maxWidth: '600px' }}>
      <div className="card-body">
        <h2 className="card-title text-center mb-4"><strong>Teacher Sign Up</strong></h2>
        ...
        <button className="btn btn-secondary w-100 mt-3" onClick={() => setIsTeacherSignUp(false)}>Back to Home</button>
      </div>
    </div>
  );
};
