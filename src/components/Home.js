const Home = ({ setIsTeacherLogin, setIsStudentLogin }) => {
  return (
    <div className="homepage text-center">
      ...
      <button onClick={() => setIsTeacherLogin(true)} className="btn btn-primary btn-lg mx-2"><strong>Teacher Login</strong></button>
      <button onClick={() => setIsStudentLogin(true)} className="btn btn-success btn-lg mx-2"><strong>Student Login</strong></button>
    </div>
  );
};
